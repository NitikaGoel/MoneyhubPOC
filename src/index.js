...
module.exports = async ({
  ...
  const moneyhub = {
    ...
    getClientCredentialTokens: ({scope, sub}) =>
      ...
      spendingAnalysisWithToken: (
        accessToken,
        bodyJson,
      ) => {
        const url = `${resourceServerUrl}/spending-analysis`
        const body = bodyJson
    ...
    getCategoriesWithToken: (token, params = {}) =>
    got(
      `${resourceServerUrl}/categories?${querystring.stringify(params)}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
    ...
    getCategorygroupsWithToken: (token, params = {}) =>
    got(
      `${resourceServerUrl}/category-groups?${querystring.stringify(params)}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
